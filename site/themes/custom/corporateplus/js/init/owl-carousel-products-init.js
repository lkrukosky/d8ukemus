    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.corporateplus.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.corporateplus.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
